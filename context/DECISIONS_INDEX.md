...
| D032 | UX | Rush de países: comparación siempre sin diacríticos (`difficulty: "easy"`), aunque el resto del competitivo fuerce `"hard"` | `decisions/07-modo-paises.md` | Implementado (`feat/modo-paises`, experimental) |
